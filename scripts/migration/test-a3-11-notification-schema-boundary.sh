...
grep -q "50 runtime relations are public-qualified" "$temp_dir/integrity.out"
...
if (Object.values(report.runtime.qualifiedRelations).reduce((sum, count) => sum + count, 0) !== 50) process.exit(1);
