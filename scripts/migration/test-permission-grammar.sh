...
if (scan.summary.total !== 36 || scan.summary.sourceCounts["dioxus-security-gate"] !== 1 || scan.summary.classificationCounts["legacy-2-segment"] !== 0) process.exit(1);
...
echo "permission-grammar self-test: PASS (36 records, 0 security-gate blockers, integrity=0, readiness=0, deterministic=stable, tamper=1)"
