...
if (scan.summary.total !== 46 || scan.summary.sourceCounts["dioxus-security-gate"] !== 12 || scan.summary.classificationCounts["legacy-2-segment"] !== 2) process.exit(1);
...
echo "permission-grammar self-test: PASS (46 records, 2 security-gate blockers, integrity=0, readiness-stop=3, deterministic=stable, tamper=1)"
