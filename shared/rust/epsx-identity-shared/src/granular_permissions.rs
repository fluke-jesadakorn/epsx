...
use std::collections::HashMap; // Clean Granular Permission System
...
mod tests {
    ...
    fn test_permission_set_operations() {
        ...
        let claim1 = GranularPermissionClaim::permanent(PermissionSource::Subscription, None);
    ...
    fn test_permission_validation() {
        ...
        let claim = GranularPermissionClaim::permanent(PermissionSource::Subscription, None);
    ...
    fn test_expired_permission_cleanup() {
        ...
        let valid_claim = GranularPermissionClaim::permanent(PermissionSource::Subscription, None);
