...
/// (default `/auth`).
///
/// In SSR, `data_connect_wallet` delegates to the generated Rust/WASM
/// EIP-1193 bridge. Hydrated callers may continue to use `on_click`.
#[component]
...
mod tests {
    ...
    //
    // The data attribute is the SSR contract consumed by Rust/WASM.
