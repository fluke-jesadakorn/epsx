...
export interface IconComponents {
    ...
    Lock: React.ComponentType<{ className?: string }>
...
const getPlatformLabels = (platform: Platform) => ({
                ...
                <div className="space-y-4">
                    ...
                    {error.current_usage !== undefined && error.limit !== undefined && (
                        <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-sm text-slate-600 dark:text-slate-400">{labels.usageLabel}</span>
                    ...
                    {error.benefits && error.benefits.length > 0 && (
                        <div>
                            ...
                            <ul className="space-y-1">
                                {error.benefits.map((benefit: string, index: number) => (
                    ...
                    {error.suggested_actions && error.suggested_actions.length > 0 && (
                        <div>
                            ...
                            <ul className="space-y-1">
                                {error.suggested_actions.map((action: string, index: number) => (
                                    <li key={index} className="text-sm text-slate-600 dark:text-slate-400 flex items-start">
