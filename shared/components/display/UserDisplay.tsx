...
// Simple user tier badge component
export function UserTierBadge({ 
  ...
  return (
    <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium border ${getTierColor(user.tier_level)} ${className}`}>
      {user.tier_level}
    </span>
  );
}
...
export function UserPermissionsDisplay({ 
  ...
  return (
    <div className={`${className}`}>
      <h4 className="text-sm font-medium text-gray-900 mb-2">Permissions (Display Only)</h4>
