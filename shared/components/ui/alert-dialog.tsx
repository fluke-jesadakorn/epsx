...
>(({ className, style, ...props }, ref) => {
    // Use state to get document.body after hydration to avoid SSR issues
    ...
    return (
        <AlertDialogPortal container={container}>
            <AlertDialogOverlay />
            {/* Wrapper div for flexbox centering - more reliable than transform-based centering */}
            <div
                style={{
                    position: 'fixed',
                    inset: 0,
