  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-gray-300 dark:border-white/20 bg-white dark:bg-white/5 backdrop-blur-sm hover:bg-black/[0.05] dark:hover:bg-white/10",
        ...
        glass: "border-gray-300 dark:border-white/20 bg-white dark:bg-white/5 backdrop-blur-xl text-foreground hover:bg-black/[0.05] dark:hover:bg-white/10",
      },
      size: {
