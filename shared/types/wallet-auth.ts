...
/**
 * Web3 permission with verification data
 */
...
export interface WalletAuthState {
  ...
  web3Permissions: Web3Permission[]
  
  // Actions
  connect: () => Promise<void>
  disconnect: () => Promise<void>
  authenticate: (signature: string, message: string, nonce: string) => Promise<void>
  logout: () => Promise<void>
 ...
 */
export function isSessionExpiringSoon(expiresAt: number | null, thresholdMs = 300000): boolean {
  if (!expiresAt) return true
