import { NotFoundError as _NotFoundError } from "../../interfaces/base-repository";
...
export class ClientPaymentRepository implements PaymentRepository {
  ...
  // TODO: Implement all payment repository methods
  // This is a stub implementation for now
  
  async get(_id: string): Promise<Payment | null> {
    throw new Error("Client payment repository not yet implemented");
  }
