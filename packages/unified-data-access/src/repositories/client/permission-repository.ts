...
export class ClientPermissionRepository implements PermissionRepository {
  ...
  // TODO: Implement all permission repository methods
  // This is a stub implementation for now
  
  async get(_id: string): Promise<Permission | null> {
    throw new Error("Client permission repository not yet implemented");
  }
