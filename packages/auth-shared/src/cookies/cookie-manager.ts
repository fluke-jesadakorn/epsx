...
export class JWTCookieManager {
  ...
  constructor(appName: 'frontend' | 'admin') {
   ...
   */
  private createCookieConfig(appName: 'frontend' | 'admin'): TokenCookies {
 ...
 */
export function createCookieManager(appName: 'frontend' | 'admin'): JWTCookieManager {
