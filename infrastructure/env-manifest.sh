...
# Rust BFFs (apps/frontend, apps/admin) — see docs/plans/2026-06-11-rust-bff-deployment.md
# The BFFs read API_URL from the k8s Deployment (not from a Secret), but these
# manifest entries remain for create-secrets.sh + validate-env.sh parity.
REQUIRED_FRONTEND_BFF="ENV API_URL FRONTEND_URL ADMIN_FRONTEND_URL WALLETCONNECT_PROJECT_ID BLOCKCHAIN_NETWORK CHAIN_ID MINIO_PUBLIC_URL"

REQUIRED_ADMIN_BFF="ENV API_URL FRONTEND_URL ADMIN_FRONTEND_URL BLOCKCHAIN_NETWORK"
