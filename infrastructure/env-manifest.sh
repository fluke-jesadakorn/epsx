...
REQUIRED_BACKEND="ENV BACKEND_URL FRONTEND_URL ADMIN_FRONTEND_URL WEB3_APP_SECRET WALLET_SIGNATURE_SECRET WEB3_SESSION_SECRET JWT_SECRET REFRESH_TOKEN_HMAC_ACTIVE_KID REFRESH_TOKEN_HMAC_KEYS_JSON BLOCKCHAIN_NETWORK COMPANY_WALLET_MAINNET BSC_MAINNET_RPC_URL"
