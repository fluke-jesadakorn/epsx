...
export const metadata = {
  title: 'Admin Manual - Feature Guide',
  description: 'Complete feature guide with screenshots for the EPSX Admin Portal',
};
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          <div className="mx-auto max-w-6xl">
            <h1 className="mb-2 text-3xl font-bold">Admin Portal Manual</h1>
            <p className="mb-8 text-gray-400">
              Complete admin feature guide. Screenshots auto-generated from E2E tests.
            </p>
