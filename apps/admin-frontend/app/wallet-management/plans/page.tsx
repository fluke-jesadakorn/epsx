/**
 * Plan List Page
 * Overview of all permission plans
 */
'use client';
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-6">
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <Link href="/wallet-management/plans/new">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {plans?.map((plan: PermissionPlan) => (
                        <Card
                            ...
                            onClick={() => router.push(`/wallet-management/plans/${plan.id}`)}
                        >
                            <CardContent className="p-5 space-y-4">
                                <div className="flex items-start justify-between">
                                    ...
                                    <Badge variant="outline" className={(plan.priority_level || 0) > 0 ? 'bg-amber-50 text-amber-600' : ''}>
