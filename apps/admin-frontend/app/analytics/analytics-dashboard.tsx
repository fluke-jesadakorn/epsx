...
function AnalyticsContent(): React.JSX.Element {
    ...
    return (
        <PageLayout>
            ...
            <Card className="bg-white dark:bg-card backdrop-blur-2xl border-gray-200 dark:border-border shadow-xl rounded-[32px] overflow-hidden">
                <CardHeader className="p-8 border-b border-gray-200 dark:border-border bg-white dark:bg-white/[0.04]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {cards.map((card) => (
                <AnalyticsSummaryCard
                    ...
                    className="bg-white dark:bg-card backdrop-blur-2xl border-gray-200 dark:border-border shadow-xl rounded-[32px] p-8"
                />
            ))}
        </div>
    );
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <AnalyticsStatsCard
                ...
                statusColor="green"
                rank={1}
                className="bg-white dark:bg-card backdrop-blur-2xl border-gray-200 dark:border-border shadow-xl rounded-[32px] overflow-hidden"
            />
            <AnalyticsStatsCard
...
function MetricsGrid({ userStats, permissionAnalytics, systemMetrics, memoryUsage }: MetricsGridProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="bg-white dark:bg-card backdrop-blur-2xl border-gray-200 dark:border-border shadow-xl rounded-[32px] overflow-hidden group">
                <CardContent className="p-8">
