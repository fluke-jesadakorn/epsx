...
const PLANS_ROUTE = '/subscriptions/plans' as const;
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setFormData({ ...formData, current_price: isNaN(val) ? 0 : val });
                      }}
                  ...
                  <div className="animate-in fade-in slide-in-from-top-2 duration-300 bg-success/5 p-6 rounded-2xl border border-success/20">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.features.map((feature) => (
                        <span key={feature} className="px-3 py-1.5 bg-success/10 text-success rounded-xl text-xs font-bold border border-success/20">
                          {feature}
                        </span>
                      ))}
                    </div>
