    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 dark:from-gray-900 dark:via-gray-900 dark:to-purple-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="h-16 bg-gradient-to-r from-pink-400 to-rose-500 rounded-2xl w-96 mx-auto mb-4 animate-pulse shadow-xl"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-gradient-to-br from-pink-400 via-rose-500 to-red-500 rounded-3xl p-8 shadow-2xl animate-pulse">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
          <div className="p-8">
            <div className="h-8 bg-gradient-to-r from-pink-400 to-rose-500 rounded-xl mb-6 w-1/3 animate-pulse"></div>
