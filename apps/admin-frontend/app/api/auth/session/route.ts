 ...
 * Web3-First: Uses Web3 wallet authentication instead of OIDC
 * Migrated from OIDC to Web3 wallet-first authentication
 */
...
// POST and PUT methods removed - Web3 sessions use different flow
// Web3 authentication happens via /api/v1/auth/web3/verify endpoint