    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <div className="flex items-center space-x-2">
          <svg className="h-4 w-4 animate-spin text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24">
    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <div className="flex flex-col gap-4 p-6 border rounded-lg">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Secure admin access with Web3 wallet</p>
