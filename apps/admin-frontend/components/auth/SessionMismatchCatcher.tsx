    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
            <div className="text-center p-8">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Refreshing Session...</h2>
                <p className="text-gray-500 dark:text-gray-400">Please wait while we synchronize your authentication state.</p>
            </div>
        </div>
    );
}
