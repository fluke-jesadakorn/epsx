      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-pulse">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-card border border-border/20 rounded-xl h-64" />
          ))}
        </div>
      </div>
    )
    ...
    <div className="space-y-6 sm:space-y-8">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div
            className="relative overflow-hidden rounded-2xl bg-card border border-border/20 shadow-xl cursor-pointer"
            onClick={() => setIsCreating(true)}
          >
            <div className="h-[3px] bg-gradient-to-r from-[#ffb237] to-[#ed4b9e]" />
            <div className="p-6 sm:p-8">
              <div className="bg-gradient-to-br from-[#ffb237]/10 to-[#ed4b9e]/10 rounded-[14px] w-12 h-12 flex items-center justify-center mb-4 sm:mb-6 border border-[#ffb237]/20">
              ...
              <div className="bg-gradient-to-r from-[#ffb237] to-[#ed4b9e] text-white rounded-xl px-4 sm:px-6 py-2 sm:py-3 text-center font-bold text-sm sm:text-base min-h-[44px] flex items-center justify-center">
                New Campaign
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-card rounded-xl p-4 sm:p-6 shadow-xl border border-border/20">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <div className="p-2 bg-gradient-to-br from-[#ffb237]/10 to-[#ed4b9e]/10 rounded-xl text-[#ffb237] border border-[#ffb237]/20">
                <Tag className="w-5 h-5" />
              </div>
              <span className="text-xs sm:text-sm font-medium text-muted-foreground">Total</span>
            </div>
            <div className="space-y-1">
              <div className="text-2xl sm:text-3xl font-bold text-foreground">{promotions.length}</div>
          ...
          <div className="bg-card rounded-xl p-4 sm:p-6 shadow-xl border border-border/20">
            ...
            <div className="space-y-1">
              ...
              <div className="text-xs sm:text-sm text-muted-foreground">Live</div>
              <div className="text-xs text-muted-foreground/60">Running now</div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl p-4 sm:p-6 shadow-xl border border-border/20">
            ...
            <div className="space-y-1">
              ...
              <div className="text-xs sm:text-sm text-muted-foreground">Redemptions</div>
              <div className="text-xs text-muted-foreground/60">Codes used</div>
            </div>
          </div>

          <div className="bg-card rounded-xl p-4 sm:p-6 shadow-xl border border-border/20">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <div className="p-2 bg-[#ffb237]/10 rounded-xl text-[#ffb237]">
                <span className="text-sm">💰</span>
              </div>
            ...
            <div className="space-y-1">
              ...
              <div className="text-xs text-muted-foreground/60">From campaigns</div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
              <button
                ...
                className={`px-4 sm:px-6 py-3 rounded-xl font-semibold text-sm sm:text-base min-h-[44px] transition-all ${filterStatus === 'all'
                  ? 'bg-gradient-to-r from-[#ffb237] to-[#ed4b9e] text-white shadow-sm'
          ...
          <div className="p-4 sm:p-6">
              ...
              {filteredPromotions.map(promotion => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-12 w-12 bg-gradient-to-br from-[#ffb237]/10 to-[#ed4b9e]/10 rounded-xl flex items-center justify-center border border-[#ffb237]/20 text-xl">
                      🎯
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <code className="bg-muted/30 text-foreground px-2 py-1 rounded text-sm font-mono border border-border/20">
                        {promotion.code}
                      </code>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="bg-muted/30 rounded-xl p-3 border border-border/20">
                      ...
                      <div className="text-lg font-bold text-[#ffb237]">{getDiscountDisplay(promotion)}</div>
                    </div>
                    <div className="bg-muted/30 rounded-xl p-3 border border-border/20">
                  ...
                  <div className="bg-muted/30 rounded-xl p-3 border border-border/20">
                    ...
                    <div className="bg-muted rounded-full h-2">
                      <div
                        className="bg-gradient-to-r from-[#ffb237] to-[#ed4b9e] rounded-full h-2 transition-all duration-500"
            ...
            <div className="hidden sm:block space-y-4">
              {filteredPromotions.map(promotion => (
                <div
                  key={promotion.id}
                  className="p-6 bg-muted/30 rounded-xl border border-border/20 transition-all hover:bg-muted/50 cursor-pointer"
                  onClick={() => setSelectedPromotion(promotion)}
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="h-14 w-14 bg-gradient-to-br from-[#ffb237]/10 to-[#ed4b9e]/10 rounded-xl flex items-center justify-center border border-[#ffb237]/20 text-2xl">
                        🎯
                      </div>
                      <div>
                        <div className="flex items-center gap-3 mb-1 flex-wrap">
                          ...
                          <code className="bg-muted/30 text-foreground px-3 py-1 rounded-lg text-sm font-mono border border-border/20">
                            {promotion.code}
                          </code>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground flex-wrap">
                          <span className="font-semibold text-[#ffb237]">
            ...
            {filteredPromotions.length === 0 && (
              <div className="text-center py-12 sm:py-16">
                <div className="h-20 w-20 bg-gradient-to-br from-[#ffb237]/10 to-[#ed4b9e]/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-[#ffb237]/20">
