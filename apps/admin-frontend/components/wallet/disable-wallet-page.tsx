        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => router.back()}
                        className="p-2.5 rounded-xl bg-muted/30 border border-border/20 hover:bg-muted/50 transition-colors"
                    >
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Restrict access for{' '}
                            <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-card rounded text-xs font-mono text-slate-300 border border-border/20">
                                {walletAddress}
                            </code>
                        </p>
                    </div>
                                    ...
                                    <label
                                        ...
                                        className={cn(
                                            ...
                                            selected
                                                ...
                                                : 'border-border/20 bg-white/[0.02] hover:border-border/20'
                                        )}
                                    >
                                        <Checkbox
                                            checked={selected}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-t border-border/20 pt-3 space-y-1.5">
                                <div className="flex items-center gap-2 text-xs">
                                    ...
                                    <span className={blockLogin ? 'text-slate-200' : 'text-muted-foreground'}>Block login</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs">
                                    <div className={cn('w-2 h-2 rounded-full', pauseSubs ? 'bg-amber-400' : 'bg-slate-600')} />
                                    <span className={pauseSubs ? 'text-slate-200' : 'text-muted-foreground'}>Pause subscriptions</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs">
                                    <div className={cn('w-2 h-2 rounded-full', notify ? 'bg-blue-400' : 'bg-slate-600')} />
                                    <span className={notify ? 'text-slate-200' : 'text-muted-foreground'}>Notify user</span>
                                </div>
                            </div>
                        </div>
