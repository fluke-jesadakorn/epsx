        ...
        <div className={cn(
            ...
            <div className="flex items-center gap-3 mb-4">
                <div className="flex-1 min-w-0">
                    <code className="text-sm font-mono font-bold text-foreground break-all bg-white/50 dark:bg-black/20 px-2 py-1 rounded">
                ...
                <div className="relative flex-shrink-0">
                    ...
                    {copied && (
                        <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] font-bold text-green-600 dark:text-green-400 bg-card px-2 py-1 rounded shadow-sm border border-green-100 dark:border-green-900/30 animate-in fade-in slide-in-from-bottom-1">
                            Copied!
                        </span>
                    )}
                </div>
            ...
            {wallet.status === 'disabled' && wallet.disableInfo !== undefined && wallet.disableInfo !== null && (
                <div className="mt-5 p-3.5 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-900/30">
                    ...
                    <div className="mt-2.5 pt-2.5 border-t border-amber-100 dark:border-amber-900/30 text-[11px] text-muted-foreground flex flex-wrap gap-x-3 gap-y-1">
