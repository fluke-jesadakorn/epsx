...
import { AccessItem } from '@/hooks/useWalletAccess';
import { cn } from '@/lib/utils';

interface WalletGroupSectionProps {
    groups: AccessItem[];
    availableGroups: AccessItem[];
    onAddGroup: (group: AccessItem) => Promise<void>;
    onRemoveGroup: (groupId: string) => Promise<void>;
    isLoading?: boolean;
    pendingDrops?: Record<string, AccessItem[]>; // Map groupID -> List of pending permissions
}
    ...
    return (
        <div className="space-y-4">
                ...
                {filteredGroups.length === 0 ? (
                    ...
                    filteredGroups.map(group => (
                        <GroupCard
                            ...
                            pendingPermissions={pendingDrops[group.id]}
                        />
                    ))
                )}
            </div>
            ...
            <AddResourceModal
                ...
                description="Assign this wallet to an access group to inherit its permissions."
