...
export function StatsCard({
  ...
  const getIconColors = () => {
    const variantMap = {
      ...
      inline: { bg: 'bg-white dark:bg-white/[0.04] backdrop-blur-sm border border-gray-200 dark:border-slate-700', text: 'text-purple-400' },
  ...
  const getCardClasses = () => {
    ...
    const baseClasses = 'bg-white dark:bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-slate-700 text-card-foreground hover:shadow-xl hover:border-purple-500/30 hover-lift transition-all duration-200';
