...
export function RankingUpgradeOverlay({
    ...
    return (
        <div className={cn(
            ...
            <div className="absolute inset-0 backdrop-blur-md bg-white dark:bg-card" />
            ...
            <div className="absolute inset-0 rounded-2xl">
                ...
                <div className="absolute inset-[1px] rounded-2xl bg-white dark:bg-card" />
            </div>
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    "bg-gradient-to-r from-gray-100/80 dark:from-slate-800/80 to-gray-200/80 dark:to-slate-700/80 border border-gray-200 dark:border-border"
                )}>
