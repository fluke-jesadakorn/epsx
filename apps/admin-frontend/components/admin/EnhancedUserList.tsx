                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                            <div className="flex space-x-2">
                              <span className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 px-2 py-1 text-xs rounded">
                                {user.packagePermissions?.length || 0} Package
                              </span>
                              {user.customPermissions &&
                                user.customPermissions.length > 0 && (
                                  <span className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 px-2 py-1 text-xs rounded">
