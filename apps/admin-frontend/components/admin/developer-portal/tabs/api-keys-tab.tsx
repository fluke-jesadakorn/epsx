...
export const ApiKeysTab: React.FC<ApiKeysTabProps> = ({
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div className="relative overflow-hidden rounded-[32px] bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-8 shadow-xl">
                ...
                <div className="mt-8 flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="relative flex-1">
                        ...
                        <Input
                            ...
                            className="pl-12 bg-white/5 border-white/10 rounded-2xl h-12 text-sm font-bold placeholder:text-muted-foreground/30 focus:ring-[#1fc7d4]/20 focus:border-[#1fc7d4]/50"
                        />
                    </div>
            ...
            {/* Table Container */}
            <div className="relative overflow-hidden rounded-[32px] bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-1 shadow-xl">
                                ...
                                <TableRow className="hover:bg-transparent">
                                    <TableCell colSpan={6} className="h-64 text-center">
                                        <div className="flex flex-col items-center justify-center space-y-3">
                                            <div className="p-4 bg-white/5 rounded-full border border-white/5 text-muted-foreground/30">
            ...
            <div className="flex items-center justify-between px-2">
                <div className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] bg-white/5 px-4 py-2 rounded-xl border border-white/5">
