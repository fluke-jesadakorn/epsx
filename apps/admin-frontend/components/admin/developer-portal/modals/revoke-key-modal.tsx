...
function KeyInfo({ clientName, walletAddress }: KeyInfoProps) {
    return (
...
interface ReasonSelectProps {
    ...
    onCustomChange: (r: string) => void;
}

function ReasonSelect({ selectedReason, customReason, onReasonChange, onCustomChange }: ReasonSelectProps) {
    return (
        <>
            <div>
            ...
            <DialogContent className="sm:max-w-md p-0 gap-0">
                ...
                <form onSubmit={(e) => { void handleSubmit(e); }}>
                    <div className="p-6 space-y-4">
                        ...
                        <KeyInfo clientName={apiKey.client_name} walletAddress={apiKey.wallet_address} />
                        <ReasonSelect
