...
export function DashboardQuickStats({ stats }: DashboardQuickStatsProps) {
    return (
        <div className="bg-white dark:bg-card rounded-[32px] p-8 shadow-xl border border-gray-200 dark:border-border relative overflow-hidden group">
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center p-3 rounded-2xl bg-white dark:bg-white/[0.04] border border-gray-200 dark:border-border transition-colors hover:bg-black/[0.05] dark:hover:bg-white/10">
