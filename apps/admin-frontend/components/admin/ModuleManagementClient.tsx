    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Module Management</h1>
            <p className="text-gray-600">Manage modules and user access assignments</p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredModules.map((module) => (
              <div key={module.id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-6">
        ...
        <div className="space-y-6">
          {selectedUser ? (
            <div>
              ...
              <div className="bg-white rounded-lg shadow">
                <div className="p-6 border-b">
                  <h3 className="text-lg font-medium text-gray-900">Module Assignments</h3>
                </div>
                    ...
                    userAssignments.map((assignment) => (
                      <div key={assignment.assignment_id} className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          <div>
                            <h4 className="font-medium text-gray-900">{assignment.display_name}</h4>
                            <p className="text-sm text-gray-500">{assignment.module_name}</p>
                          </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 text-center">
              ...
              <p className="text-gray-500 mb-4">Choose a user from the Users tab to view and manage their module assignments</p>
      ...
      {activeTab === 'users' && (
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-gray-500">Select a user to manage their module assignments</p>
          </div>
          <div className="divide-y">
            {users.map((user) => (
      ...
      {showAssignDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b">
              <h2 className="text-lg font-semibold text-gray-900">Assign Modules</h2>
              <p className="text-sm text-gray-500">Select modules and configure access levels</p>
            </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    {assignmentForm.assignments.map((assignment) => {
                      ...
                      return (
                        <div key={assignment.module_id} className="p-4 bg-gray-50 rounded-lg">
      ...
      {showModuleDetails && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b">
              <h2 className="text-lg font-semibold text-gray-900">{showModuleDetails.display_name}</h2>
              <p className="text-sm text-gray-500">{showModuleDetails.name}</p>
            </div>
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">{showModuleDetails.description || 'No description available'}</p>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Category</h3>
                    <p className="text-gray-600">{showModuleDetails.category}</p>
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Version</h3>
                    <p className="text-gray-600">v{showModuleDetails.version}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{showModuleDetails.dependencies_count} modules</p>
                  </div>
                </div>
                
                <div>
                  <h3 className="font-medium text-gray-900 mb-2">Access Levels</h3>
                ...
                <div>
                  <h3 className="font-medium text-gray-900 mb-2">Default Quotas</h3>
