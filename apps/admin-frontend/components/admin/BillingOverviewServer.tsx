    ...
    <div className="space-y-6">
      ...
      <div className="pancake-card p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Current Bill Details</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-gray-900">Usage Summary</h4>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Average Cost per 1K</span>
                <span className="font-medium">
      ...
      <div className="pancake-card overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Module Usage Breakdown</h3>
        </div>
          ...
          <div className="space-y-3">
            {currentBill.pricing.discounts.map((discount, index) => (
              <div key={index} className="flex justify-between items-center">
                <div>
                  <div className="font-medium text-green-800">{discount.description}</div>
                  <div className="text-sm text-green-600">Applied to this billing period</div>
                </div>
