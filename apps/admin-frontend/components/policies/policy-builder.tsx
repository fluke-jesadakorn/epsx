/* eslint-disable @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-explicit-any */
'use client';
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      {showTemplates && (
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-purple-500/20 via-orange-500/20 to-purple-500/20 p-0.5">
          <div className="relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {templates.map(template => (
                <div key={template.id} className="bg-white/5 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/10 cursor-pointer hover:scale-[1.02] hover:border-purple-500/30 transition-all">
        ...
        <div className="relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <select
                className="w-full px-3 py-3 border-2 border-white/20 rounded-2xl bg-white/5 dark:bg-slate-800/50 backdrop-blur-sm text-foreground min-h-[44px]"
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-purple-500/20 via-orange-500/20 to-purple-500/20 p-0.5">
        <div className="relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
            ...
            <Button size="sm" onClick={addTargetAction} className="min-h-[44px] rounded-2xl bg-gradient-to-r from-purple-500 to-orange-500 hover:shadow-xl hover:shadow-purple-500/30 w-full sm:w-auto">
          ...
          <div className="space-y-3">
            {formData.target_actions.map((action, index) => (
              <div key={index} className="flex items-center gap-3 p-3 sm:p-4 bg-white/5 dark:bg-slate-800/50 backdrop-blur-sm border border-white/10 rounded-2xl">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-purple-500/20 via-orange-500/20 to-purple-500/20 p-0.5">
        <div className="relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
              <select
                className="px-3 py-2 border-2 border-white/20 rounded-2xl text-sm bg-white/5 dark:bg-slate-800/50 backdrop-blur-sm text-foreground min-h-[44px]"
              ...
              <Button size="sm" onClick={addCondition} className="min-h-[44px] rounded-2xl bg-gradient-to-r from-purple-500 to-orange-500 hover:shadow-xl hover:shadow-purple-500/30 w-full sm:w-auto">
                <PlusIcon className="h-4 w-4 mr-2" />
                Add Condition
              </Button>
            </div>
          ...
          <div className="space-y-4">
            {formData.conditions.conditions.map((condition, index) => {
              ...
              return (
                <div key={index} className="p-4 border-2 border-white/10 rounded-2xl bg-white/5 dark:bg-slate-800/50 backdrop-blur-sm">
          ...
          <div className="relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2 p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">{testResults.final_decision_reason}</p>
              </div>
