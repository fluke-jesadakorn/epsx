...
type NotificationVariant = 'default' | 'pancake' | 'admin' | 'analytics' | 'premium';
...
export function UnifiedNotification({
  ...
  const typeStyles = {
    ...
    success: {
      ...
      dark: { bg: 'bg-green-600', text: 'text-white' }
    },
    warning: {
...
interface ToastNotification extends Omit<UnifiedNotificationProps, 'visible' | 'onClose'> {
  id: string;
}

interface UseUnifiedToastProps {
  variant?: NotificationVariant;
  iconType?: IconType;
  position?: Position;
