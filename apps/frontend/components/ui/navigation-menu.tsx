...
// Simplified navigation menu components as fallbacks
// These provide basic functionality without @radix-ui/react-navigation-menu dependency
...
>(({ className, ...props }, ref) => (
  <a
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "block w-full", className)}
    {...props}
  />
))
