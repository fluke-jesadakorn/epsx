      ...
      <CardContent className="p-6 pt-16">
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2">
            <div className="h-6 bg-gradient-to-r from-orange-300/20 to-yellow-300/20 rounded-lg animate-pulse" />
            <div className="h-4 bg-gradient-to-r from-blue-300/20 to-purple-300/20 rounded-lg animate-pulse" />
          </div>
          
          <div className="grid grid-cols-3 gap-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-16 bg-gradient-to-br from-slate-100/50 to-slate-200/50 dark:from-slate-700/30 dark:to-slate-800/30 rounded-xl animate-pulse" />
            ))}
          </div>
          
          <div className="h-12 bg-gradient-to-r from-orange-200/30 to-yellow-200/30 rounded-xl animate-pulse" />
          
          <div className="space-y-2">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-8 bg-gradient-to-r from-slate-100/30 to-slate-200/30 dark:from-slate-700/20 dark:to-slate-800/20 rounded-lg animate-pulse" />
            ))}
          </div>
        </div>
