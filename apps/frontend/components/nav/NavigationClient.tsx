    ...
    >
      <div className="max-w-8xl mx-auto flex h-20 items-center px-6">
        ...
        <button
          ...
          className="lg:hidden fixed top-5 right-4 flex items-center justify-center w-10 h-10 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 active:scale-95 transition-all"
          style={{ zIndex: 60 }}
