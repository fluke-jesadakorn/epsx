        ...
        {topics.map((topic) => {
          ...
          return (
            <button
              ...
              className={`group p-3.5 rounded-xl border ${color.border} bg-white dark:bg-slate-900/40 hover:bg-slate-50 dark:hover:bg-gray-100 dark:bg-slate-800/40 transition-all text-left shadow-sm hover:shadow-md ${color.glow}`}
            >
