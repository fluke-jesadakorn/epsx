        ...
        {topics.map((topic) => {
          ...
          return (
            <button
              ...
              className={`group p-3.5 rounded-xl border ${color.border} bg-white dark:bg-slate-800/40 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-all text-left shadow-sm hover:shadow-md ${color.glow}`}
            >
