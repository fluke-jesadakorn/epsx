        ...
        <div className="space-y-8">
            ...
            {error ? (
                ...
                <div className="grid gap-4">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="animate-pulse h-24 bg-white/50 dark:bg-gray-800/50 rounded-3xl border-2 border-gray-100 dark:border-gray-700/50"></div>
                    ))}
                </div>
            ) : payments.length === 0 ? (
                ...
                <div className="grid gap-4">
                    {payments.map((payment) => (
                        <div key={payment.id} className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-5 sm:p-6 shadow-lg border-2 border-gray-100 dark:border-gray-800 hover:border-blue-200 dark:hover:border-blue-800/50 transition-all duration-300">
                            ...
                            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
                        </div>
                    ))}
                </div>
            )}
