...
import type { AccessOverviewData} from '@/shared/api/users';
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 p-8 text-white shadow-2xl group">
                ...
                {/* Decorative circles */}
                <div className="absolute top-0 right-0 -mr-16 -mt-16 h-64 w-64 rounded-full bg-white/20 blur-3xl group-hover:bg-white/30 transition-colors" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl border-2 border-gray-100 dark:border-gray-800 p-6 shadow-xl relative overflow-hidden group">
                        ...
                        <div className="absolute -bottom-8 -right-8 h-24 w-24 bg-green-500/5 rounded-full blur-2xl group-hover:bg-green-500/10 transition-colors" />
                    </div>
