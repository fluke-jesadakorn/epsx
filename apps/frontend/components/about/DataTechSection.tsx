  ...
  return (
    <div className="relative flex flex-col gap-8 w-full p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto my-8 sm:my-16 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 w-20 h-20 bg-gradient-to-br from-orange-400/10 to-yellow-400/10 rounded-full" />
        <div className="absolute bottom-20 right-20 w-16 h-16 bg-gradient-to-br from-blue-400/10 to-cyan-400/10 rounded-full" />
        <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-full" />
      </div>

      {/* Section Header with PancakeSwap styling */}
      <div className="relative text-center space-y-6 mb-8 px-4">
        <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-600 dark:from-orange-400 dark:via-yellow-400 dark:to-orange-500 bg-clip-text text-transparent">
          🍰 DataTech Platform
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 relative overflow-hidden bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-orange-200/50 dark:border-orange-400/20 mx-2 sm:mx-0 rounded-3xl">
          ...
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-400/10 to-yellow-400/10 rounded-full blur-xl" />
          
          <CardHeader className="relative z-10">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent mb-4">
              🚀 What is a DataTech Platform?
            </h3>
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              <p className="text-lg leading-relaxed">
                A <strong className="bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent font-bold">DataTech Platform</strong> is a comprehensive technology ecosystem designed to handle your complete data journey.
              </p>
              <p className="leading-relaxed">
                From initial <span className="font-semibold text-orange-600 dark:text-orange-400">collection and storage</span> to advanced <span className="font-semibold text-blue-600 dark:text-blue-400">analysis and visualization</span>, these platforms integrate cutting-edge tools to maximize data value.
              </p>
            </div>
          </CardHeader>
        </Card>
        ...
        {/* Key Features Card */}
        <Card className="relative overflow-hidden bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-blue-200/50 dark:border-blue-400/20 mx-2 sm:mx-0 rounded-3xl">
          ...
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-blue-400/10 to-cyan-400/10 rounded-full blur-xl" />
          
          <CardHeader className="relative z-10">
            <h3 className="text-xl font-bold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent mb-4">
              💡 Why It Matters
            </h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-2 sm:px-0">
        {features.map((feature, index) => {
          ...
          return (
            <Card 
              key={feature.id} 
              className="relative group bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-orange-200/30 dark:border-orange-400/20 rounded-2xl overflow-hidden"
            >
              {/* Card background decoration */}
              <div className={`absolute inset-0 bg-gradient-to-br ${bgGradients[index]} opacity-50`} />
              <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${bgGradients[index]} rounded-full blur-xl`} />
              
              <CardHeader className="relative z-10">
                <h3 className={`text-xl sm:text-2xl font-bold bg-gradient-to-r ${gradients[index]} bg-clip-text text-transparent`}>
                  {feature.title}
                </h3>
              </CardHeader>
