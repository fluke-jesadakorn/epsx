...
const HeroSection: React.FC<HeroSectionProps> = ({ style, className }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative text-center space-y-10 max-w-3xl mx-auto px-6 py-12 sm:px-8">
        <div className="space-y-4">
          ...
          <p className="text-xl md:text-2xl font-medium bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent max-w-2xl mx-auto leading-relaxed">
            Unlock deeper insights and make smarter investment decisions with
            real-time EPS tracking and advanced analytics
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/ranking" className="cursor-pointer">
            <Button
              size="lg"
              className="cursor-pointer bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-full h-12 px-8 font-semibold"
            >
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full h-12 px-8 font-semibold hover:bg-primary/10 cursor-pointer"
            onClick={handleShare}
          >
