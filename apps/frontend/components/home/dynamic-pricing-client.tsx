        ...
        try {
            ...
            if (response.ok) {
                ...
                if (result.success && result.data && Array.isArray(result.data)) {
                    ...
                    // If response has affiliate info, we could set it potentially (backend doesn't always return it in this endpoint structure broadly, but assuming for now)
                    // setAffiliateInfo(...) 
                }
            }
        } catch (err) {
