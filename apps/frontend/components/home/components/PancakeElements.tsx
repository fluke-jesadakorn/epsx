...
export function FloatingElements({
  className = '',
}: FloatingElementsProps): React.JSX.Element {
  return (
    <div
...
export function EmojiBadge({
  ...
  const variants = {
    ...
    warning:
      'bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-300 dark:border-yellow-700/30',
    error:
