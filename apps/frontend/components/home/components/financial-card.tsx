...
export function FinancialCard({
  ...
  return (
    ...
    >
      ...
      {/* Rank Badge */}
      <div className="absolute top-3 sm:top-4 left-3 sm:left-4 z-30 w-10 sm:w-12 h-10 sm:h-12 flex items-center justify-center drop-shadow-lg ring-2 ring-blue-400/60 backdrop-blur-md bg-white/60 dark:bg-slate-900 rounded-full transition-all duration-300 hover:scale-105 hover:ring-4 hover:ring-blue-500/80">
