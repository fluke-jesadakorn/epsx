...
export function QuarterRow({ 
  ...
  return (
    <div className={`
      group/row relative flex flex-wrap sm:grid sm:grid-cols-5 
      items-center ${SPACING.itemGap} p-3 rounded-lg 
    ...
    `}>
      ...
      <div className="flex flex-col items-end sm:items-end min-w-[80px]">
        ...
        <span className={`${TYPOGRAPHY.caption} text-slate-400 sm:hidden`}>
          Price
        </span>
      </div>
