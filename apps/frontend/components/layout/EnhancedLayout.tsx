...
// HOC for pages that need the enhanced layout
export function withEnhancedLayout<P extends object>(
  ...
  const WrappedComponent = React.forwardRef<any, P>((props, ref) => {
    return (
      <EnhancedLayout {...options}>
        <Component {...props} ref={ref} />
      </EnhancedLayout>
    );
  });

  WrappedComponent.displayName = `withEnhancedLayout(${Component.displayName || Component.name})`;
...
export const MemoizedEnhancedLayout = React.memo(EnhancedLayout);
