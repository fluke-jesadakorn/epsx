...
import { User, Settings, Database, Shield, Mail, Download } from 'lucide-react';
          ...
          <CardHeader className="text-center pb-4">
            ...
            <div className="flex justify-center mt-2">
              <Badge 
                ...
                className={user.verified ? "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300" : ""}
              >
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg text-sm">
                        <Badge variant="outline">{user.tier?.toUpperCase() || 'FREE'}</Badge>
                      </div>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">
