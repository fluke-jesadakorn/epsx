  ...
  return (
    <div className="space-y-8 p-6 rounded-xl border bg-card shadow-sm">
      <div className="space-y-2">
        <h3 className="text-2xl font-bold text-primary">Step 2: Select Payment Method</h3>
        <p className="text-muted-foreground">Choose your preferred cryptocurrency payment network</p>
      </div>

      <div className="space-y-6">
        <div className="p-6 bg-muted/50 rounded-xl border space-y-4">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="8"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
        ...
        {currency === 'USDT' && (
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="network" className="font-semibold">USDT Network</Label>
            </div>
