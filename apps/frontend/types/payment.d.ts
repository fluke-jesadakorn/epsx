/**
 * FRONTEND PAYMENT TYPES - MIGRATED TO SHARED
...
// Legacy compatibility (frontend was importing from different paths)
export type { PermissionTemplateName } from '@/app/constants/packages';