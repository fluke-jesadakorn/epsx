        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <p><strong>User ID:</strong> {(user as any)?.user_id || (user as any)?.id || (user as any)?.uid || 'Not available'}</p>
              <p><strong>Email Verified:</strong> {(user as any)?.emailVerified ? 'Yes' : 'No'}</p>
