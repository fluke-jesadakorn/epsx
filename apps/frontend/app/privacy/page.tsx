        ...
        <div className="space-y-6">
          ...
          <Card className="p-8 bg-[#27262c] border-[#383241] rounded-[24px] shadow-xl">
            <div className="prose prose-invert prose-purple max-w-none">
              <h3 className="text-2xl font-bold text-purple-400 mb-4">1. Information We Collect</h3>
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">2. How We Use Your Information</h3>
              <p className="text-gray-300">We use the collected information for:</p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">3. Third-Party Services</h3>
              <p className="text-gray-300">
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">4. Data Security</h3>
              <p className="text-gray-300">
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">5. Your Rights</h3>
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">6. Changes to Privacy Policy</h3>
              <p className="text-gray-300">
              ...
              <h3 className="text-2xl font-bold text-purple-400 mt-8 mb-4">7. Contact Us</h3>
              <p className="text-gray-300">
