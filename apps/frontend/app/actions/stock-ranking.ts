...
import type { MarketCountry } from '@/types/market';
...
export async function fetchStockRankingData(
  ...
  return await getStockFinancialData(page, limit, country, quarters);
}
...
export async function fetchStockRankingDataWithPermissions(
  ...
  return await getStockFinancialData(page, defaultLimit, country, quarters);
}
