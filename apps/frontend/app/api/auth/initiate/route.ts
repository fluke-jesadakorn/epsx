/**
 * Frontend OAuth Initiation Route for EPSX Backend
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔄 Frontend: Initiating OAuth flow with PKCE...');
    ...
    console.log('✅ Frontend: PKCE parameters stored in cookies successfully');
    ...
    console.error('❌ Frontend: OAuth initiation failed:', error);
