...
const AutomationDashboard = (): React.JSX.Element => {
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">Data Processing Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <TokenGatedFeature
          ...
          fallback={
            <div className="p-4 border rounded-lg bg-gray-50">
              <h2 className="text-xl font-semibold mb-2">Data Processing Bot</h2>
              <p className="text-gray-600">
                Upgrade to access automated data processing features
              </p>
            </div>
          }
        >
          <div className="p-4 border rounded-lg">
            <h2 className="text-xl font-semibold mb-4">Data Processing Bot</h2>
        ...
        <TokenGatedFeature feature={TokenFeature.PORTFOLIO_MANAGEMENT}>
          <div className="p-4 border rounded-lg">
            <h2 className="text-xl font-semibold mb-4">Data Collection Management</h2>
            <div className="space-y-2">
              <div className="flex justify-between">
        ...
        <TokenGatedFeature
          ...
          fallback={
            <div className="col-span-2 p-4 border rounded-lg bg-gray-50">
              ...
              <p className="text-gray-600">
                Hold more EPSx tokens to access advanced data processing tools
              </p>
            </div>
          }
        >
