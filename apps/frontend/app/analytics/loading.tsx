          ...
          <div className="relative">
            <div className="space-y-8">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="relative overflow-hidden rounded-2xl border border-blue-200/50 bg-white/60 p-6 backdrop-blur-sm dark:border-blue-700/50 dark:bg-slate-800/60">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="border rounded-xl p-4 space-y-3 bg-white/40 backdrop-blur-sm dark:bg-slate-800/40">
                    <div className="flex items-center justify-between">
