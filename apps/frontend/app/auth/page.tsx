    ...
    return (
        <div className="dark relative flex min-h-screen w-full flex-col overflow-hidden bg-[#020617] lg:flex-row">
            ...
            <div className="relative z-10 hidden w-full flex-col justify-center p-8 text-white lg:flex lg:w-3/5 xl:p-20 overflow-hidden">
                ...
                <div className="grid gap-8 sm:grid-cols-2 max-w-2xl">
                    {features.map((feature, i) => (
                        <div key={i} className="flex gap-4 group animate-slide-up" style={{ animationDelay: `${i * 100}ms` }}>
                            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-border ring-1 ring-white/5 backdrop-blur-sm group-hover:bg-orange-500/10 group-hover:border-orange-500/20 transition-all duration-300">
                ...
                <div className="mt-16 flex items-center gap-6 py-6 border-t border-gray-200 dark:border-border max-w-md">
            ...
            <div className="relative z-10 flex w-full items-center justify-center p-4 sm:p-6 lg:w-2/5 lg:bg-white/[0.02] lg:backdrop-blur-3xl lg:border-l lg:border-gray-200 dark:border-border">
                <div className="w-full max-w-md">
                    ...
                    {/* Auth Card */}
                    <div className="card-insight-enhanced group relative overflow-hidden bg-white/90 dark:bg-slate-950/60 border-gray-200 dark:border-border p-6 sm:p-8 lg:p-10 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.5)] backdrop-blur-3xl rounded-2xl sm:rounded-3xl animate-slide-up">
                        {/* Shimmer Effect */}
                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-5 sm:space-y-6">
                                ...
                                <div className="pt-5 sm:pt-6 border-t border-gray-200 dark:border-border">
                                ...
                                {/* Mobile Features */}
                                <div className="lg:hidden pt-5 sm:pt-6 border-t border-gray-200 dark:border-border">
                                    <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                        {features.map((feature, i) => (
                                            <div key={i} className="flex flex-col items-center text-center p-3 sm:p-4 rounded-xl bg-white/[0.02] border border-gray-200 dark:border-border hover:bg-white/[0.04] transition-colors">
