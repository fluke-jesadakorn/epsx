-- Fix case-sensitivity issue in get_wallet_permissions_detailed_working function
-- The function was using case-sensitive matching for wallet addresses, but wallet addresses
-- can be stored with different cases in the database. This caused permissions to not be found
-- when the wallet address case didn't match exactly.
