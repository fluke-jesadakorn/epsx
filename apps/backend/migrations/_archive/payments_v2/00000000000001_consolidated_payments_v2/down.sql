-- ============================================================================
-- EPSX PAYMENTS CONSOLIDATED SCHEMA v2 - ROLLBACK
-- ============================================================================

SELECT 'Starting EPSX payments schema rollback...' AS status_message;
...
SELECT 'EPSX payments schema rollback completed!' AS completion_message;
