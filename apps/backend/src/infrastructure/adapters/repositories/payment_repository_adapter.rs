...
impl PaymentRepositoryAdapter {
  ...
  async fn map_from_legacy(
    &self,
    _legacy_data: LegacyPaymentData
    ...
    Err(
      "Payment reconstruction from legacy data not yet implemented".to_string()
    )
  }
  ...
  async fn store_payment_data(
    &self,
    payment_data: &LegacyPaymentData
  ) -> Result<(), String> {
    info!(
  ...
  async fn load_payment_data(
    &self,
    payment_id: &PaymentId
  ) -> Result<Option<LegacyPaymentData>, String> {
...
mod tests {
  ...
  impl UserRepository for MockUserRepository {
    async fn create_user(
      &self,
      _user: crate::domain::shared_kernel::entities::user::User
    ) -> Result<
      crate::domain::shared_kernel::entities::user::User,
    ...
    async fn find_user_by_id(
      ...
      Option<crate::domain::shared_kernel::entities::user::User>,
      Box<dyn std::error::Error + Send + Sync>
    > {
      Ok(None)
    }
    ...
    async fn list_users(
      ...
      Vec<crate::domain::shared_kernel::entities::user::User>,
      Box<dyn std::error::Error + Send + Sync>
    > {
      Ok(vec![])
    }
  ...
  async fn test_payment_adapter_creation() {
    ...
    let adapter = PaymentRepositoryAdapter::new(mock_pool, mock_user_repo);
