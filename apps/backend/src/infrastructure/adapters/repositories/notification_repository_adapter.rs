    ...
    async fn persist_wallet_notification(
        ...
        diesel::insert_into(wallet_notifications::table)
            .values((
                ...
                wallet_notifications::recipient_wallet_address
                    .eq(Some(wallet_address.to_lowercase())),
                wallet_notifications::title.eq(notification.content().title()),
                wallet_notifications::body.eq(notification.content().body()),
                wallet_notifications::notification_type
                    .eq(format!("{:?}", notification.notification_type())),
