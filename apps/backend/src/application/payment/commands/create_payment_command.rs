...
use crate::domain::payment::{
    Payment, PaymentAmount, PaymentId, PaymentMethod, PaymentRepositoryPort,
};
...
impl CommandHandler<CreatePaymentCommand> for CreatePaymentCommandHandler {
    async fn handle(
    ...
    ) -> ApplicationResult<CreatePaymentResponse> {
        info!(
        ...
        let mut payment = Payment::create(command.wallet_address, command.amount, command.method)
            .map_err(|e| {
        ...
        // Save the payment
        self.payment_repository.save(&payment).await.map_err(|e| {
...
mod tests {
    ...
    impl PaymentRepositoryPort for MockPaymentRepository {
        ...
        async fn find_by_status(
            &self,
            _status: crate::domain::payment::PaymentStatus,
        ) -> Result<Vec<Payment>, String> {
            Ok(vec![])
        }
        ...
        async fn find_by_reference(
            &self,
            _reference: &crate::domain::payment::PaymentReference,
        ...
        async fn get_user_payment_stats(
            ...
            Ok(crate::domain::payment::PaymentStats {
                ...
                failed_payments: 0,
                total_amount: PaymentAmount::new(
                    rust_decimal::Decimal::ZERO,
                    crate::domain::payment::Currency::USD,
                )
                .unwrap(),
                average_amount: PaymentAmount::new(
                    rust_decimal::Decimal::ZERO,
                    crate::domain::payment::Currency::USD,
                )
                .unwrap(),
        ...
        async fn list_admin_subscriptions_with_plan_names(
            &self,
            _filters: crate::domain::payment::repository_ports::SubscriptionFilters,
            _page: u32,
            _per_page: u32,
        ) -> Result<
            Vec<(
                crate::domain::payment::repository_ports::Subscription,
                Option<String>,
            )>,
            String,
        > {
        ...
        async fn get_analytics_rollup(
            &self,
            _window: crate::domain::payment::repository_ports::AnalyticsWindow,
        ...
        async fn create_payment(&self, _cmd: PortCreatePaymentCommand) -> Result<Payment, String> {
            unimplemented!("mock test helper — the round-trip test lives in the cross-pool adapter")
        }
        ...
        async fn grant_subscription(
            &self,
            _cmd: PortActivateSubscriptionCommand,
