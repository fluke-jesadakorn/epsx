...
use crate::domain::notification::{
    DeliveryChannelType, DeliveryResult, NotificationRepositoryPort,
};
use crate::prelude::*;
...
impl CommandHandler<RecordDeliveryAttemptCommand> for RecordDeliveryAttemptCommandHandler {
    async fn handle(
    ...
    ) -> ApplicationResult<RecordDeliveryAttemptResponse> {
        // 1. Find notification
        ...
        notification
            .record_delivery_attempt(channel.as_str(), delivery_result)
