...
/// Command to create a notification for a specific user
#[derive(Debug, Clone)]
pub struct CreateUserNotificationCommand {
    /// Recipient wallet address (UUID)
...
impl Command for CreateUserNotificationCommand {
    type Response = CreateUserNotificationResponse;
}

/// Response returned after successfully creating a user notification
