...
mod tests {
    ...
    fn grant_permission_command_validation_success() {
        let command =
            GrantPermissionCommand::new("user_123".to_string(), "admin:users:manage".to_string());
    ...
    fn grant_permission_command_validation_emptyuser_id() {
        let command = GrantPermissionCommand::new("".to_string(), "admin:users:manage".to_string());
    ...
    fn grant_permission_command_validation_invalid_permission_format() {
        let command =
            GrantPermissionCommand::new("user_123".to_string(), "invalid_format".to_string());
