...
pub async fn get_available_countries(
    ...
    info!(
        "Returning {} available countries with display names",
        response.count
    );
    Ok(Json(response))
}
...
pub async fn get_all_valid_countries() -> Result<Json<CountriesResponse>, AppError> {
    ...
    let countries = get_available_countries_with_labels();
    debug!(
        "Found {} valid countries for TradingView API",
        countries.len()
    );
    ...
    info!(
        "Returning {} valid countries with display names",
        response.count
    );
    Ok(Json(response))
}
...
pub async fn get_sectors_by_country(
    ...
    let sectors = service
        .get_sectors_by_country(params.country.clone())
        .await
        .map_err(|e| {
            AppError::new(
...
pub fn get_available_countries_with_labels() -> Vec<CountryData> {
    vec![
        ...
        CountryData {
            value: "bahrain".to_string(),
            label: "Bahrain".to_string(),
        },
        CountryData {
            value: "bangladesh".to_string(),
            label: "Bangladesh".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "cyprus".to_string(),
            label: "Cyprus".to_string(),
        },
        CountryData {
            value: "czech".to_string(),
            label: "Czech Republic".to_string(),
        },
        CountryData {
            value: "denmark".to_string(),
            label: "Denmark".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "estonia".to_string(),
            label: "Estonia".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "greece".to_string(),
            label: "Greece".to_string(),
        },
        CountryData {
            value: "hongkong".to_string(),
            label: "Hong Kong".to_string(),
        },
        CountryData {
            value: "hungary".to_string(),
            label: "Hungary".to_string(),
        },
        CountryData {
            value: "iceland".to_string(),
            label: "Iceland".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "indonesia".to_string(),
            label: "Indonesia".to_string(),
        },
        CountryData {
            value: "ireland".to_string(),
            label: "Ireland".to_string(),
        },
        CountryData {
            value: "israel".to_string(),
            label: "Israel".to_string(),
        },
        CountryData {
        ...
        CountryData {
            ...
            label: "Kenya".to_string(),
        },
        CountryData {
            value: "kuwait".to_string(),
            label: "Kuwait".to_string(),
        },
        CountryData {
            value: "latvia".to_string(),
            label: "Latvia".to_string(),
        },
        CountryData {
            value: "lithuania".to_string(),
            label: "Lithuania".to_string(),
        },
        CountryData {
            value: "luxembourg".to_string(),
            label: "Luxembourg".to_string(),
        },
        CountryData {
            value: "malaysia".to_string(),
            label: "Malaysia".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "newzealand".to_string(),
            label: "New Zealand".to_string(),
        },
        CountryData {
            value: "nigeria".to_string(),
            label: "Nigeria".to_string(),
        },
        CountryData {
            value: "norway".to_string(),
            label: "Norway".to_string(),
        },
        CountryData {
            value: "pakistan".to_string(),
            label: "Pakistan".to_string(),
        },
        CountryData {
            value: "peru".to_string(),
            label: "Peru".to_string(),
        },
        CountryData {
            value: "philippines".to_string(),
            label: "Philippines".to_string(),
        },
        CountryData {
            value: "poland".to_string(),
            label: "Poland".to_string(),
        },
        CountryData {
            value: "portugal".to_string(),
            label: "Portugal".to_string(),
        },
        CountryData {
            value: "qatar".to_string(),
            label: "Qatar".to_string(),
        },
        CountryData {
            value: "romania".to_string(),
            label: "Romania".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "ksa".to_string(),
            label: "Saudi Arabia".to_string(),
        },
        CountryData {
            value: "serbia".to_string(),
            label: "Serbia".to_string(),
        },
        CountryData {
        ...
        CountryData {
            ...
            label: "Slovakia".to_string(),
        },
        CountryData {
            value: "rsa".to_string(),
            label: "South Africa".to_string(),
        },
        CountryData {
            value: "korea".to_string(),
            label: "South Korea".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "srilanka".to_string(),
            label: "Sri Lanka".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "taiwan".to_string(),
            label: "Taiwan".to_string(),
        },
        CountryData {
            value: "thailand".to_string(),
            label: "Thailand".to_string(),
        },
        CountryData {
        ...
        CountryData {
            value: "uae".to_string(),
            label: "United Arab Emirates".to_string(),
        },
        CountryData {
            value: "uk".to_string(),
        ...
        CountryData {
            value: "venezuela".to_string(),
            label: "Venezuela".to_string(),
        },
        CountryData {
            value: "vietnam".to_string(),
            label: "Vietnam".to_string(),
        },
    ]
}
...
pub fn get_available_countries_static() -> Vec<String> {
    get_available_countries_with_labels()
        .into_iter()
        .map(|c| c.value)
        .collect()
}
