...
pub async fn system_metrics_handler(
    ...
    use crate::application::market_analytics::queries::{
        GetSystemMetricsQuery, GetSystemMetricsQueryHandler,
    };
    ...
    let json_response = serde_json::to_value(&response).map_err(|e| {
...
pub async fn admin_time_series_handler(
    ...
    use crate::application::market_analytics::queries::{
        GetAdminTimeSeriesQuery, GetAdminTimeSeriesQueryHandler,
    };
    use crate::application::market_analytics::queries::{MetricType, TimeSeriesGranularity};
    use crate::application::shared::QueryHandler;
    ...
    tracing::info!(
        "Admin timeseries request (CQRS) - Start: {}, End: {}, Granularity: {:?}",
        start_date,
        end_date,
        granularity
    );
...
pub async fn admin_modules_handler(
    ...
    use crate::application::market_analytics::queries::{
        GetAdminModulesQuery, GetAdminModulesQueryHandler,
    };
    use crate::application::shared::QueryHandler;
    ...
    tracing::info!(
        "Admin modules request (CQRS) - Include inactive: {:?}",
        include_inactive
    );

    // Create query
    let query = GetAdminModulesQuery { include_inactive };
