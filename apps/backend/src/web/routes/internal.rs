...
impl InternalRoutes {
    ...
    pub async fn create_routes(
        ...
        let settings_routes = Router::new()
            .route("/config", get(crate::web::settings::handlers::get_system_config_handler))
            .route("/features", get(crate::web::settings::handlers::get_feature_flags_handler));

        // Internal notification routes (simplified)
        let notification_routes = Router::new()
            .route("/", get(crate::web::notifications::handlers::get_user_notifications))
            .route("/unread", get(crate::web::notifications::handlers::get_unread_notifications))
            .route("/preferences", get(crate::web::notifications::handlers::get_preferences))
            .route("/preferences", put(crate::web::notifications::handlers::update_preferences));
        ...
        let internal_router = Router::new()
            ...
            .route("/health", get(crate::web::health_handler))
