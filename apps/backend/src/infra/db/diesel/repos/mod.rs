...
pub mod audit_repo;
pub mod stock_repo;
// Removed: iam_repo, permission_profile_repo, temporary_permission_repo
pub mod module_repo;
pub mod usage_repo;
pub mod eps_repo;
...
// Removed permission repository exports
pub use module_repo::{DieselModuleRepo, StubModuleRepo};
pub use usage_repo::{DieselUsageRepo, StubUsageRepo};
