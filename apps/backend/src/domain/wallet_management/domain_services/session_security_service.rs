...
impl SessionSecurityService {
    ...
    pub fn analyze_wallet_sessions(
        &self,
...
mod tests {
    ...
    fn create_test_session_with_ip(ip: &str) -> Session {
        use crate::domain::wallet_management::value_objects::wallet_address::WalletAddress;
    ...
    fn multiple_active_sessions_triggers_analysis() {
        ...
        let analysis = service.analyze_wallet_sessions(&wallet_address, &sessions);
