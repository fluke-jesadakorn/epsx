...
mod tests {
    ...
    fn test_quality_rating() {
        assert_eq!(
            EPSValue::new(15.0).unwrap().quality_rating(),
            EPSQuality::Excellent
        );
        assert_eq!(
            EPSValue::new(3.0).unwrap().quality_rating(),
            EPSQuality::Good
        );
        assert_eq!(
            EPSValue::new(1.0).unwrap().quality_rating(),
            EPSQuality::Fair
        );
        assert_eq!(
            EPSValue::new(0.1).unwrap().quality_rating(),
            EPSQuality::Poor
        );
        assert_eq!(
            EPSValue::new(-0.5).unwrap().quality_rating(),
            EPSQuality::Negative
        );
    }
