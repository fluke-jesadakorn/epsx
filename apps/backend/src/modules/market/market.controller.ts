...
export class MarketController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns paginated list of companies EPS growth data sorted by EPS growth percentage. Access levels: Public (rank >21), Basic (rank >11), Premium (all ranks)",
  })
  @ApiQuery({
    name: "limit",
    required: false,
  ...
  async getEpsGrowth(
    ...
    return this.marketService.getEpsGrowth(
      skip,
      limit,
