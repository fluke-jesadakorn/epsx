...
COMMENT ON TABLE security_events IS 'Security middleware event logging with threat intelligence';
COMMENT ON TABLE attack_attempts IS 'Brute force and attack attempt tracking';
COMMENT ON TABLE ip_blacklist IS 'IP-based security blocking system';
COMMENT ON TABLE notifications IS 'Enhanced user notification system';
COMMENT ON TABLE eps_growth_analytics IS 'EPS growth analytics for stock ranking';

COMMENT ON VIEW user_permissions_view IS 'Modern view for JWT token generation with user permissions';
COMMENT ON VIEW role_history IS 'Role history compatibility view for DatabaseRoleService';
...
COMMENT ON FUNCTION cleanup_expired_firebase_sessions() IS 'Cleanup function for expired Firebase sessions';

-- ============================================================================
-- SCHEMA INITIALIZATION COMPLETE
-- ============================================================================
-- This consolidated schema provides:
-- ✅ Core user management with Firebase auth
-- ✅ Granular admin module permission system  
-- ✅ Unified permission system with inheritance
-- ✅ Enterprise security infrastructure
-- ✅ Complete audit and logging capabilities
-- ✅ EPS analytics and notifications
-- ✅ Performance optimizations with comprehensive indexing
-- ✅ JWT integration functions
-- ✅ Initial seed data for immediate use
-- 
-- Total tables: 20+ core tables
-- Total indexes: 50+ performance indexes  
-- Total functions: 4 helper functions
-- Total views: 3 optimized views