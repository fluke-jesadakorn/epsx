-- EPSX Database Seed File - Cleaned and Optimized Schema
-- Generated after comprehensive database cleanup migrations 023-026
-- This represents the final, streamlined database structure

-- ============================================================================
-- CORE USER MANAGEMENT TABLES
-- ============================================================================

-- Users table (cleaned and optimized)
...
DROP TABLE IF EXISTS eps_growth_analytics CASCADE;
...
-- This schema represents the cleaned and optimized EPSX database structure
-- Generated after migrations 023-026 which removed:
-- - 5 complex module system tables (sub_modules, user_sub_module_assignments, api_keys, module_usage_logs, module_assignment_audit)
-- - 3 legacy permission system tables (permission_profiles, admin_permission_profile_assignments, assignment_audit_log)
-- - Redundant fields and duplicate functionality
--
-- The result is a streamlined schema with:
-- - 10 core tables (vs 18+ before)
-- - Modern admin modules as the primary permission system
