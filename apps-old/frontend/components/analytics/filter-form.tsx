        ...
        <div className="flex flex-col gap-3 p-3 sm:flex-row sm:items-end sm:gap-3 sm:p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Select value={filters.country} onValueChange={(v) => updateFilter('country', v)}>
              <SelectTrigger className="h-9 border-gray-200 dark:border-white/[0.08] bg-gray-100 dark:bg-slate-800/60 text-sm text-gray-700 dark:text-slate-200 hover:bg-gray-200 dark:hover:bg-slate-700">
