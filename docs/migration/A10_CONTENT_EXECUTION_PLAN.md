...
| Admin/client | `target-admin-plain-content`, `target-admin-status-collapse`, `target-client-status-collapse` | Some reads omit request context, and generic client/BFF mapping collapses distinct `403/409/422/429` outcomes. |
