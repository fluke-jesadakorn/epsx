...
- **5 partial:** `/audit-log`, `/news`, `/notifications`, `/notifications/manage`, and `/wallet-management`;
- **20 blocked**;
...
8. the accepted baseline remains 2 aligned / 5 partial / 20 blocked until evidence is deliberately updated.
