...
- **6 partial:** `/audit-log`, `/media`, `/news`, `/notifications`, `/notifications/manage`, and `/wallet-management`;
- **19 blocked**;
...
8. the accepted baseline remains 2 aligned / 6 partial / 19 blocked until evidence is deliberately updated.
