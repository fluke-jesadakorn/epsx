...
Target Rust/Dioxus SHA: `79b246a6338e28b1e6762c70aee0fdfbe4117303`

Generated: 2026-07-31T07:50:09.410Z
...
| `pr6.admin.notifications-redirect` | `desktop-light` | PASS; 2 clean repeats | [![Next.js source](./pr6.admin.notifications-redirect--desktop-light--source.png)](./pr6.admin.notifications-redirect--desktop-light--source.png) | [![Rust/Dioxus target](./pr6.admin.notifications-redirect--desktop-light--target.png)](./pr6.admin.notifications-redirect--desktop-light--target.png) | [![highlighted diff](./pr6.admin.notifications-redirect--desktop-light--diff.png)](./pr6.admin.notifications-redirect--desktop-light--diff.png) | 5.174% | The target canonicalizes the legacy administrator notification path to the backend-verified inventory instead of rendering the source command-center fallback and its unrelated synthesized operational cards. | pre=PASS, post=PASS |
